...
try {
  ...
  for (const requiredPath of [
    ...
    "examples/microsoft-agent-framework/dotnet/README.md",
    "examples/microsoft-agent-framework/dotnet/Program.cs",
    "examples/microsoft-agent-framework/dotnet/global.json",
    "examples/azure-sre-agent/worldcut_gate.py",
    "examples/azure-sre-agent/SKILL.md",
    "examples/azure-sre-agent/requirements.txt",
    "docs/PROTOCOL.md",
    "docs/PRODUCTION.md",
